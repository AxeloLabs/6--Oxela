...
// import FirebaseOxelaIcon from '@/components/icons/firebaseOxela'
// import FirebaseOxelaGlowIcon from '@/components/icons/firebaseOxelaGlow'
// import FirebaseOxelaWaIcon from '@/components/icons/firebaseOxelaWa'
import User from '../../icons/user'
import HamburgerButton from './hamburger-button'
import CartIcon from './cart-icon'
import {Combobox, ComboboxInput, ComboboxOption, ComboboxOptions, MenuItem} from '@headlessui/react'
      ...
      <div className="container relative">
        <div className="max-w-screen-2xl mx-auto flex gap-10 items-center h-[60px]">
          ...
          >
            ...
            {/* <FirebaseOxelaWaIcon className="oxela-glow size-8 shrink-0" /> */}
            {/* <FirebaseOxelaIcon className="neon-logo size-8 shrink-0" /> */}
            {/* <FirebaseOxelaGlowIcon className="oxela-glow size-8 shrink-0" /> */}
            <span className="text-2xl font-bold whitespace-nowrap mt-1">Oxela</span>
          </Link>
